...
function populateLayerMaterialsMenu() {
    ...
    const materials = [
        { name: 'Standard', thumbnail: '/assets/textures/standard.jpg', metalness: 0, roughness: 0.5 },
        { name: 'Metallic', thumbnail: '/assets/textures/metallic.jpg', metalness: 1, roughness: 0.2 },
        { name: 'Glossy', thumbnail: '/assets/textures/glossy.jpg', metalness: 0, roughness: 0.1 },
        { name: 'Matte', thumbnail: '/assets/textures/matte.jpg', metalness: 0, roughness: 0.9 }
    ];
